		...
		<div class="card-header text-center">
			<div class="row">
				...
				<div class="col-md-2" style="text-align: right;">
					...
					<a href="{{ route('rpt_admision_hospitalizacion_pdf',[$fecha_inicial, $fecha_final]) }}" class="btn btn-sm btn-reporte" title="Impresión" target="_blank"><i class="fas fa-file-pdf"></i></a>
					<a href="{{ route('rpt_admision_hospitalizacion_xls',[$fecha_inicial, $fecha_final]) }}" class="btn btn-sm btn-excel" title="Excel"><i class="fas fa-file-excel"></i></a>
				</div>
			</div>
		</div>
		<div class="card-body">
				...
				<table id="tbladmisiones" class="table table-sm table-hover text-center">
					<thead>
						<tr>
							...
							<th>Expediente</th><th>Paciente</th><th>Hospital</th>
							<th>Ingreso</th><th>Egreso</th><th>Estado</th>
						</tr>
					</thead>
					<tbody>
...
@section('js')
	...
	function fn_buscar(){
		...
		return window.location.href = "{{route('inicio')}}/reportes/admision_hospitalizacion/"+fecha_inicial+"/"+fecha_final;
    }
	</script>
@endsection