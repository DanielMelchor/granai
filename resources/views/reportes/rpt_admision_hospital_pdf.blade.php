    ...
    <table class="table table-borderless">
      <tr>
        ...
        <td width="90%">
          ...
          <h5>Hospitalizaciones del {{\Carbon\Carbon::parse($fecha_inicial)->format('d/m/Y')}} al {{\Carbon\Carbon::parse($fecha_final)->format('d/m/Y')}}</h5>
        </td>
      </tr>
    </table>
</header>
        ...
        <table class="table table-sm table-striped text-center">
          <thead>
            <tr>
              ...
              <th>Expediente</th><th colspan="2">Paciente</th><th colspan="2">Hospital</th>
          ...
          <tbody>
            ...
            <tr>
              <td>{{ $a->admision }}</td>
                ...
                <td colspan="2">{{ $a->paciente_nombre }}</td>
                <td colspan="2">{{ $a->hospital_nombre }}</td>
