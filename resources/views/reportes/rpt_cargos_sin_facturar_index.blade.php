		...
		<div class="card-header text-center">
			<div class="row">
				...
				<div class="col-md-2" style="text-align: right;">
					...
					<a href="{{ route('rpt_cargos_sin_facturar_pdf') }}" class="btn btn-sm btn-reporte" title="Impresión" target="_blank"><i class="fas fa-file-pdf"></i></a>
					<a href="{{ route('rpt_cargos_sin_facturar_xls') }}" class="btn btn-sm btn-excel" title="Excel"><i class="fas fa-file-excel"></i></a>
				</div>
			</div>
		</div>
		<div class="card-body">
		      			...
		      			<div class="card-footer">
		      				<div class="row">
		      					<div class="col-md-4 offset-md-8" style="text-align: right;">
		      						...
		      						<a href="#" class="btn btn-sm btn-danger" title="Salir"><i class="fas fa-sign-out-alt"></i></a>
		      					</div>
		      				</div>
		      			</div>
		      		</div>
...
@section('js')
	...
	/*function fn_buscar(){
		...
		return window.location.href = "{{route('inicio')}}/reportes/admisiones_activas/"+fecha_inicial+"/"+fecha_final;
    }*/
	</script>
@endsection