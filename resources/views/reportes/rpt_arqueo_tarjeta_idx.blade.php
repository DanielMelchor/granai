		...
		<div class="card-header text-center">
			<div class="row">
				...
				<div class="col-md-2" style="text-align: right;">
					...
					<a href="{{ route('rpt_arqueo_tarjetas_pdf',[$caja_id, $fecha_inicial, $fecha_final]) }}" class="btn btn-sm btn-reporte" title="Impresión" target="_blank"><i class="fas fa-file-pdf"></i></a>
					<a href="{{ route('rpt_arqueo_tarjetas_xls', [$caja_id, $fecha_inicial, $fecha_final]) }}" class="btn btn-sm btn-excel" title="Excel"><i class="fas fa-file-excel"></i></a>
				</div>
			</div>
		</div>
		<div class="card-body">
...
@section('js')
	...
	function fn_buscar(){
		...
		return window.location.href = "{{route('inicio')}}/reportes/arqueo_tarjetas/"+caja_id+"/"+fecha_inicial+"/"+fecha_final;
    }
	</script>
@endsection