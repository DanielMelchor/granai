    ...
    <table class="table table-borderless">
      <tr>
        ...
        <td width="90%">
          ...
          <h5>Consultas realizadas del {{\Carbon\Carbon::parse($fecha_inicial)->format('d/m/Y')}} al {{\Carbon\Carbon::parse($fecha_final)->format('d/m/Y')}}</h5>
        </td>
      </tr>
    </table>
</header>
        ...
        <table class="table table-sm table-striped text-center">
          <thead>
            <tr>
              ...
              <th>Expediente</th><th>Paciente</th>
              <th>Estado</th>
            </tr>
          </thead>
          <tbody>
