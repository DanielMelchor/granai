...
<head>
  ...
  <title>Admisiones Activas</title>
  <style>
    @page {
        margin: 0px 0px;
        font-family: Arial;
    ...
    <table class="table table-borderless">
      <tr>
        ...
        <td width="90%">
          ...
          <h5>Admisiones Activas del {{\Carbon\Carbon::parse($fecha_inicial)->format('d/m/Y')}} al {{\Carbon\Carbon::parse($fecha_final)->format('d/m/Y')}}</h5>
        </td>
      </tr>
    </table>
</header>
