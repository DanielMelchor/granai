...
@section('contenido')
	...
	<form role="form" method="POST" action="{{route('actualizar_producto', $pProducto->id )}}">
		@csrf
				...
				<div class="card-body">
						...
						<div class="col-md-5 offset-md-1">
                            <div class="form-group form-control-sm clearfix">
                                ...
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="producto" name="clasificacion_producto" value="PROD" onclick="fn_actualizar_tipo();" @if($pProducto->clasificacion == 'PROD') then checked @endif>
                                    <label for="producto">Producto</label>
                                </div>
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="servicio" name="clasificacion_producto" value="SERV" onclick="fn_actualizar_tipo();" @if($pProducto->clasificacion == 'SERV') then checked @endif>
                                    <label for="servicio">Servicio</label>
                                </div>
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="procedimiento" name="clasificacion_producto" value="PROC" onclick="fn_actualizar_tipo();" @if($pProducto->clasificacion == 'PROC') then checked @endif>
					...
					<div class="row">
						<div id="grpsiglas" class="input-group mb-1 col-md-5 offset-md-1">
						  	...
						  	<input type="text" class="form-control" placeholder="solo para procedimientos" aria-label="Username" aria-describedby="basic-addon1" id="siglas" name="siglas" value="{{ $pProducto->siglas }}">
						</div>
					</div>
					<div class="row">
						<div id="grpdescripcion" class="input-group mb-1 col-md-10 offset-md-1">
						  	...
						  	<input type="text" class="form-control" placeholder="Descripcion interna" aria-label="Username" aria-describedby="basic-addon1" id="descripcion" name="descripcion" required value="{{ $pProducto->descripcion  }}">
						</div>
					</div>
					<div class="row">
						<div id="grpdescripcionm" class="input-group mb-1 col-md-10 offset-md-1">
						  	...
						  	<input type="text" class="form-control" placeholder="texto a mostrar en documentos del cliente" aria-label="Username" aria-describedby="basic-addon1" id="descripcion_a_mostrar" name="descripcion_a_mostrar" required value="{{ $pProducto->descripcion_a_mostrar }}">
						</div>
					</div>
					<div class="row">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <select class="custom-select custom-select-sm select2 select2bs4" id="medida_id"  name="medida_id">
                                    ...
                                    @foreach($pUnidades as $U)
                                        <option value="{{ $U->id}}" @if($pProducto->medida_id == $U->id) then selected @endif>{{ $U->descripcion}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
					...
					<div class="row">
						<div class="form-group offset-md-1">
				            <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
				              	<input type="checkbox" class="custom-control-input" id="estado" name="estado" value="A" @if($pProducto->estado == 'A') then checked @endif>
