...
@section('contenido')
	...
	<form role="form" method="POST" action="{{route('grabar_especialidad')}}">
		@csrf
				...
				<div class="card-body">
					<div class="row text-center">
					    <div class="input-group mb-5 col-md-2 offset-md-1">
						  	...
						  	<input type="text" class="form-control" placeholder="Iniciales" aria-label="Username" aria-describedby="basic-addon1" id="iniciales" name="iniciales" autofocus required value="{{ old('iniciales')}}" style="text-transform: uppercase;">
						</div>
						<div class="input-group mb-5 col-md-6">
					  		<div class="input-group-prepend">
						    	<span class="input-group-text">Descripcion</span>
						  	</div>
						  	<input type="text" class="form-control" placeholder="nombre especialidad" aria-label="Username" aria-describedby="basic-addon1" id="descripcion" name="descripcion" autofocus required value="{{ old('descripcion')}}">
						</div>
			        </div>
			        <div class="row">
